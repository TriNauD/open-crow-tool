...
> **2026-08-31 夜间批次**：P0 全部（R2～R5）与 P1 小项（R6 Web 端、R8、R11）已完成开发并提 PR（🟨 标注 PR 号），待逐个 Review + Preview 验证后 merge；另产出 [`docs/用户手册.md`](./用户手册.md)。
...
| R7 | 移动端触屏 Enter 换行 | 并入 v1.8 需求 | S | ⬜ |
